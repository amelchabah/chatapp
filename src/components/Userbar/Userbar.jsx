...
const Userbar = () => {
    ...
    const toggleUserbar = () => {
        const userbar = document.querySelector(`.${styles.userbar}`);

        if (userbar) {
            if (userbar.classList.contains(styles.active)) {
                userbar.classList.remove(styles.active);
                userbar.classList.add(styles.inactive);
            } else {
                userbar.classList.remove(styles.inactive);
                userbar.classList.add(styles.active);
            }
        }
    };
    return (
        <div className={`${styles.userbar} ${styles.inactive}`} onClick={toggleUserbar}>
            <h3>
